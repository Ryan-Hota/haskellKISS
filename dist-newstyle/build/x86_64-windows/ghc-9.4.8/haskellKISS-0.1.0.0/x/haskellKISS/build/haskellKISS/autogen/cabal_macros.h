...
/* package haskellKISS-0.1.0.0 */
#ifndef VERSION_haskellKISS
#define VERSION_haskellKISS "0.1.0.0"
#endif /* VERSION_haskellKISS */
#ifndef MIN_VERSION_haskellKISS
#define MIN_VERSION_haskellKISS(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskellKISS */
...
#define CURRENT_COMPONENT_ID "haskellKISS-0.1.0.0-inplace-haskellKISS"
